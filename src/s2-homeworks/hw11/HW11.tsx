      ...
      <div className={s2.hw}>
        <div className={s.container}>
          <div className={s.wrapper}>
            ...
            <SuperRange id={"hw11-single-slider"} value={value1} onChange={change} valueLabelDisplay="auto" />
          </div>
          <div className={s.wrapper}>
            <span id={"hw11-value-1"} className={s.number}>
              {value1}
            </span>
            <SuperRange id={"hw11-double-slider"} value={[value1, value2]} onChange={change} valueLabelDisplay="auto" />
